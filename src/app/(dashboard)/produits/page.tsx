    ...
    const filteredProducts = products
        ...
        .sort((a, b) => {
            switch (sortOption) {
                ...
                case "SALES_DESC": return (b.soldCount || 0) - (a.soldCount || 0);
                case "SALES_ASC": return (a.soldCount || 0) - (b.soldCount || 0);
                default: return 0;
            }
        });
                ...
                <div className="flex items-center gap-2 w-full md:w-auto">
                    ...
                    <div>
                        <select
                            ...
                            className="h-10 pl-3 pr-4 rounded-lg text-sm appearance-none cursor-pointer text-foreground bg-white/5 border border-white/10 hover:bg-white/10 focus:ring-0 transition-colors"
                        >
